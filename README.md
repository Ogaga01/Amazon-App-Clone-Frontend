...
**Amazon Clone** A clone of the Amazon.com website. Add to cart, edit user details.
...
- [Live Demo Link](https://scintillating-pixie-59f96e.netlify.app)
...
```
git@github.com/Ogaga01/Amazon-App-Clone-Frontend.git
```
...
Feel free to check the [issues page](https://github.com/Ogaga01/Amazon-App-Clone-Frontend/issues).
